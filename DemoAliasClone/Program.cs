...
//(1) Ô nhớ alpha mà c1 đang quản lý lúc nãy bị trống
...
//Ta không thể nào láy được giá trị tại ô nhớ này nữa
...
// -> bất kì 1 đối tượng nào đổi giá trị tại ô nhớ Beta
...
Customer c4 = c3;
c3 = c1;
//không thu hồi ô nhớ của c3 đang quản lý ở dòng 36
...
Console.WriteLine("---Thông tin của p1 khi p2 bị thay đổi---");
Console.WriteLine(p1);
...
Product p5 = p3;
p3 = p4;
//Hệ điều hành có thu hồi ô nhớ đã cấp phát cho p3 quản lý trước đó hay không? vì sao?
//nếu bổ sung
p5 = p3;
//thì có thu hồi ô nhớ đã cấp phát cho p3 hay không? vì sao?

Product p6 = p4.Clone();
//Hệ điều hành sao chép toàn bộ dữ liệu trong ô nhớ mà p4 đang quản lý qua 1 ô nhớ mới
//và giao cho p6 quản lysoo nhớ mới này:
